...
def start_ATC(name,runways,neighbourATC,port):
    ...
    takeoff_q.put("a84")
    takeoff_q.put("a85")
    landing_q_insert("a810", 100)
    landing_q_insert("a814", 120)
    landing_q_insert("a815", 130)
    landing_q_insert("a816", 150)
    landing_q_insert("a817", 25)
    landing_q_insert("a818", 70)
    landing_q_insert("a819", 100)
...
def sessions1(methods=['GET','POST']):
    start_ATC('atc3',3,[('atc1',40),('atc2',30)],8000)
